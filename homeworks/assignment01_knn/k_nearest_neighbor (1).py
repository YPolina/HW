...
class KNearestNeighbor:
    ...
    def compute_distances_two_loops(self, X):
        ...
        for i in range(num_test):
            for j in range(num_train):
                ...
                train_sqr = np.sum(self.X_train[j] ** 2)
                test_sqr = np.sum(X[i] ** 2)
                cross_prod = np.dot(X[i], self.X_train[j].T)
                dists = np.sqrt(train_sqr + test_sqr - 2 * cross_prod)
    ...
    def compute_distances_no_loops(self, X):
        ...
        cross_prod = np.dot(X, self.X_train.T)
        dists = np.sqrt(train_squared + test_squared - 2 * cross_prod)
    ...
    def predict_labels(self, dists, k=1):
        ...
        for i in range(num_test):
            ...
            closest_y = [self.y_train[i] for i in K_neighbors]
            # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
            #########################################################################
            # TODO:                                                                 #
